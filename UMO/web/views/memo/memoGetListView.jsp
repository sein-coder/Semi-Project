...
<body>
	<div id="memo_list" class="new_win">
		...
		<div class="new_win_con">
			<ul class="win_ul">
				<li class="selected"><a href="<%=request.getContextPath()%>/views/memo/memoGetListView.jsp">받은쪽지</a></li>
				<li><a href="<%=request.getContextPath()%>/views/memo/memoSendListView.jsp">보낸쪽지</a></li>
				<li><a href="<%=request.getContextPath()%>/views/memo/memoWriteView.jsp">쪽지쓰기</a></li>
			</ul>
			<div class="win_total">
				<span> 전체 받은쪽지 1통<br>
				</span>
